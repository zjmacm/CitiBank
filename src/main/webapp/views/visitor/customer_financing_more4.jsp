...
<head>
    ...
    window.onload = function() {
        ...
        var arr = ['url(/public/images/s4_1.png)',
            'url(/public/images/s4_2.png)',
            'url(/public/images/s4_3.png)'
        ];
        var i = 0;
        $('.dot').each(function() {
            ...
            <div class="center">
                ...
                <div class="center-right">
                    ...
                    <div class="imgBox" id="slider">
                        <div class="banner">
                            <ul id="banner-image">
                                <li style="background-image: url(/public/images/rotate4_1.png)"></li>
                                <li style="background-image: url(/public/images/rotate4_2.png)"></li>
                                <li style="background-image: url(/public/images/rotate4_3.png)"></li>
                            </ul>
                        </div>
                    </div>
                </div>
