...
<head>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            var arr = ['url(/public/images/s3_1.png)',
                'url(/public/images/s3_2.png)',
                'url(/public/images/s3_3.png)'
            ];
            var i = 0;
            $('.dot').each(function () {
...
<div id="main">
    <div class="container">
        ...
        <div class="center">
            ...
            <div class="center-right">
                ...
                <div class="imgBox" id="slider">
                    <div class="banner">
                        <ul id="banner-image">
                            <li style="background-image: url(/public/images/rotate3_1.png)"></li>
                            <li style="background-image: url(/public/images/rotate3_2.png)"></li>
                            <li style="background-image: url(/public/images/rotate3_3.png)"></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bottom">
            ...
            <div class="center-content">
                <p class="content">
                    大连君悦酒店拥有370间豪华海景房，酒店所有房间都拥有无与伦比的辽阔海景。其中包括28间风格雅致的套房。2,568平方米的活动及会议空间，其中包括层高8米的854平方米无柱大宴会厅与390平方米的悦海厅与9个面积各异的小宴会厅，均拥有良好的自然采光。高速无线网络接入与先进的可视影像设备。悦水疗设有1个豪华双人理疗间及3个豪华单人理疗间，提供一系列的身体与面部护理。拥有自然采光的20米恒温泳池。
                </p><br/>
            </div>
            <div class="bottom-title-line">
