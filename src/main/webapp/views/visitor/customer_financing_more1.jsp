    ...
    <div id="main">
        <div class="container">
            ...
            <div class="bottom">
                ...
                <div class="center-content">
                    <p class="content">公司致力于向广大客户提供高端智能化数字测试仪器， 以及接地电阻、泄漏电流、相序、功率等非接触式远程在线监测解决方案。 其产品广泛应用于电力、通信、军事、石油、化工、气象、铁路及工矿企业等领域。 公司拥有高水平的技术研发团队，在产品研发与制造上积极遵照国际电工委员会IEC1010标准， 专注于研制安全、耐用、精确的高端数字检测产品，并不断对现有产品升级换代。 公司还拥有卓有成效的管理团队、兢兢业业的优秀员工，确保我们的产品技术领先、品质优良。
                    </p>
                    <br/>
                </div>
                <div class="bottom-title-line">
